...
#if (USE_TETRIS == 1)
// **************** НАСТРОЙКИ ТЕТРИС ****************
#define FAST_SPEED 200     // скорость падения при удержании "вниз" (меньше - быстрее)
#define STEER_SPEED 400    // скорость перемещения в бок при удержании кнопки (меньше - быстрее) на BT версии не работает!
